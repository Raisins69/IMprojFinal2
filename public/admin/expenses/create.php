...
<div class="admin-container">
    ...
    <main class="admin-content">
        ...
        <form class="form-box" method="POST" id="expenseForm" novalidate>
            ...
            <div class="form-group">
                ...
                <select id="category" name="category" class="form-input">
                    ...
                    <option value="Supplies" <?= (isset($_POST['category']) && $_POST['category'] === 'Supplies') ? 'selected' : '' ?>>Supplies</option>
                    ...
                    <option value="Other" <?= (isset($_POST['category']) && $_POST['category'] === 'Other' || !isset($_POST['category'])) ? 'selected' : '' ?>>Other</option>
                </select>
                <div class="error-message"></div>
            </div>
