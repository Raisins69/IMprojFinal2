...
<div class="admin-container">
    ...
    <main class="admin-content">
        ...
        <form class="form-box" method="POST" id="userForm" novalidate>
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       data-min-length="3"
                       data-max-length="50"
                       data-pattern="^[a-zA-Z0-9_\-.]{3,50}$"
                       data-pattern-message="Username must be 3-50 characters and can only contain letters, numbers, underscores, hyphens, and periods">
